...
description: A practical approach to running multiple PostgreSQL databases in a single Docker Compose service using a custom entrypoint script.
image: /images/posts/docker-compose-whale.png
published: True
---
